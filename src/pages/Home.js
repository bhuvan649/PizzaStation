...
const Home = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url('/images/PizzaStation.png')` }} 
    >
      <div className="bg-black bg-opacity-60 p-8 rounded text-center text-white max-w-xl mx-4">
        ...
        <button
          ...
          className="bg-orange-500 hover:bg-orange-600 text-white text-lg px-6 py-3 rounded-xl shadow-md transition-transform transform hover:scale-105"
